...
public class DpDomainObject extends AbstractDomainObjectAdapter {
    private static final Logger logger = LoggerFactory.getLogger(DpDomainObject.class);
    ...
    protected DpDomainObject() {
        super();
    }

    protected DpDomainObject(DomainObjectAllocator.OID oid) {
