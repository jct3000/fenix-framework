...
public class DpBackEnd implements BackEnd {
    private static final Logger logger = LoggerFactory.getLogger(DpBackEnd.class);
    public static final String BACKEND_NAME = "dp";

    protected final TransactionManager transactionManager;

    public DpBackEnd() {
        this.transactionManager = new DpTransactionManager();
    }
